/**
 * agent-api-gateway-api - Package 2: api for Intelligent API Gateway
 * Project: agent-api-gateway
 */
export class AgentApiGatewayApi {
  constructor(options = {}) {
    this.name = 'agent-api-gateway-api';
...
export default AgentApiGatewayApi;
